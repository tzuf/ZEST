...
import random
import json
from dataset import DatasetNAB
import copy
...
parser.add_argument('--model', default='similarity_VS', type=str, help='the type of ZEST model to use: vanilla/similarity/similarity_VRS')
...
def train():
    ...
    training_set = DatasetNAB(opt)
    training_generator = data.DataLoader(training_set, **params)
    test_set = DatasetNAB(opt,train=False)
